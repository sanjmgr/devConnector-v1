...
router.get('/', passport.authenticate('jwt', {session:false}), (req, res) => {
	...
	Profile
		...
		.then(profile => {
			if (!profile) {
				errors.noprofile = 'There is no proile for this user';
...
router.post('/', passport.authenticate('jwt', {session:false}), (req, res) => {
	...
	if (req.body.linkined) profileFields.social.linkined = req.body.linkined;
...
router.post(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }).then(profile => {
      ...
      // Add to exp array at the begining instead of last
